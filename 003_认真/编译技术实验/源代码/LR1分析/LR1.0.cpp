/*
 * @Author: Chen
 * @Date: 2021-11-14 14:03:34
 * @LastEditTime: 2021-11-15 14:19:34
 * @FilePath: \C++ projects\compile\LR1分析\LR1.0.cpp
 */
#include <iostream>
#include <vector>
#include <map>
 ...
 */
LR1::LR1(string s){
    _talbeLR[0] = {{'+', "error"}, {'*', "error"}, {'(', "S4"}, {')', "error"}, {'i', "S5"}, {'#', "error"}, {'E', "1"}, {'T', "2"}, {'F', "3"}};
    _talbeLR[1] = {{'+', "S6"}, {'*', "error"}, {'(', "error"}, {')', "error"}, {'i', "error"}, {'#', "acc"}, {'E', "error"}, {'T', "error"}, {'F', "error"}};
    _talbeLR[2] = {{'+', "R2"}, {'*', "S7"}, {'(', "error"}, {')', "R2"}, {'i', "error"}, {'#', "R2"}, {'E', "error"}, {'T', "error"}, {'F', "error"}};
    _talbeLR[3] = {{'+', "R4"}, {'*', "R4"}, {'(', "error"}, {')', "R4"}, {'i', "error"}, {'#', "R4"}, {'E', "error"}, {'T', "error"}, {'F', "error"}};
    _talbeLR[4] = {{'+', "error"}, {'*', "error"}, {'(', "S4"}, {')', "error"}, {'i', "S5"}, {'#', "error"}, {'E', "8"}, {'T', "2"}, {'F', "3"}};
    _talbeLR[5] = {{'+', "R6"}, {'*', "R6"}, {'(', "error"}, {')', "R6"}, {'i', "error"}, {'#', "R6"}, {'E', "error"}, {'T', "error"}, {'F', "error"}};
    _talbeLR[6] = {{'+', "error"}, {'*', "error"}, {'(', "S4"}, {')', "error"}, {'i', "S5"}, {'#', "error"}, {'E', "error"}, {'T', "9"}, {'F', "3"}};
    _talbeLR[7] = {{'+', "error"}, {'*', "error"}, {'(', "S4"}, {')', "error"}, {'i', "S5"}, {'#', "error"}, {'E', "error"}, {'T', "error"}, {'F', "10"}};
    _talbeLR[8] = {{'+', "S6"}, {'*', "error"}, {'(', "error"}, {')', "S11"}, {'i', "error"}, {'#', "error"}, {'E', "error"}, {'T', "error"}, {'F', "error"}};
    _talbeLR[9] = {{'+', "R1"}, {'*', "S7"}, {'(', "error"}, {')', "R1"}, {'i', "error"}, {'#', "R1"}, {'E', "error"}, {'T', "error"}, {'F', "error"}};
    _talbeLR[10] = {{'+', "R3"}, {'*', "R3"}, {'(', "error"}, {')', "R3"}, {'i', "error"}, {'#', "R3"}, {'E', "error"}, {'T', "error"}, {'F', "error"}};
    _talbeLR[11] = {{'+', "R5"}, {'*', "R5"}, {'(', "error"}, {')', "R5"}, {'i', "error"}, {'#', "R5"}, {'E', "error"}, {'T', "error"}, {'F', "error"}};
